              ...
              <div class="card-body">
                ...
                <br>
                  ...
                  <tbody>
                    ...
                    if($consulta_admin_delete>0){
                        while($dato1=mysqli_fetch_array($admin_delete_user)){
                    ...
                    <tr>
                        ...
                        <td>
                          <div class="content">
                          <a href="php_admin/habilitar_admin.php?id=<?php echo $dato1['id'];?>"> <button type="button" class="btn btn-block btn-outline-success btn-sm">HABILITAR</button>
                        </a>
                          </div>
                        </td>          
                    </tr>
