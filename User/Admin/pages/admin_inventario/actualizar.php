              ...
              <form action="../../PHP/update.php" method="POST"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tipo" id="exampleInputEmail1" placeholder="TIPO"value="<?php echo $id[1]?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">SERIE</label>
                    <input type="text" class="form-control"  name="serie" id="exampleInputPassword1" placeholder="SERIE" value="<?php echo $id[2]?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">N° SERIAL</label>
                    <input type="text" class="form-control"  name="serial" id="exampleInputPassword1" placeholder="N° SERIAL" value="<?php echo $id[3]?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control"  name="descripcion" id="exampleInputPassword1" placeholder="DESCRIPCION" value="<?php echo $id[5]?>"><?php echo $id[5]?></textarea>
                  </div>
